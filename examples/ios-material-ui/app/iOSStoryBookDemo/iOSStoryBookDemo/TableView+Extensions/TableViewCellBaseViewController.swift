...
class TableViewCellBaseViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func sectionHeight(_ section: Int) -> CGFloat {
        ...
        if ( section == tableViewCellOptions.count - 1 ) && tableViewCellOptions[section].items.isEmpty {
            // XD wants to add a line to the bottom of the tableview
            height = 1
        } else
        if tableViewCellOptions[section].sectionType == .instruction {
            height = TableViewCellBaseViewController.instructionHeight
        } else
        if tableViewCellOptions[section].sectionType == .errorMessage {
            var ratio: CGFloat = 1.0
            let contentSize = UIApplication.shared.preferredContentSizeCategory
            switch contentSize.rawValue {
            ...
            height = TableViewCellBaseViewController.errorMessageHeight * ratio
        } else {
...
//
//        if scaleFont {
//            label.font = tableSection.sectionType == .instruction ? UIFont.preferredFont(forTextStyle: .subheadline) : UIFont.preferredFont(forTextStyle: .footnote)
//        } else {
...
//            let accessorySwitch = IDSSwitch()
//            cell.accessoryView = accessorySwitch
//            cell.selectionStyle = .none
//
//            accessorySwitch.isEnabled = enabled
//            accessorySwitch.isOn = selected
//            accessorySwitch.tag = item.tag
//
//            accessorySwitch.addTarget(self, action: Selector.accessorySwitchChanged, for: .valueChanged)
//
//        case .textField:
//            addTextFieldToCell(indexPath, cell.contentView)
//            cell.selectionStyle = .none
//
//            // no divider line between text fields
...
//            }
    ...
    func addTextFieldToCell(_ indexPath: IndexPath, _ contentView: UIView) {
        // subclass should override to add the text field to a tableview cell.
    }
